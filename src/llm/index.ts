 ...
 *
 * Priority:
 * 1. GROQ_API_KEY env var (free tier, fast)
 * 2. OPENAI_API_KEY env var (paid, high quality)
...
export function createAutoLLMProviderSync(): LLMProvider | null {
  ...
  // 3. Create Ollama provider without availability check
